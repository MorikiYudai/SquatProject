...
#Tinterを使用してWindowsを作成　windowサイズやwindowの背景の色
window = tk.Tk()
...
button.place(x=10, y=800)


frame = tk.Frame(height=600, width=980)
